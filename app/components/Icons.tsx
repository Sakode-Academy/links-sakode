...
export function WhatsappIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M12 2C6.477 2 2 6.477 2 12c0 2.15.682 4.14 1.84 5.772L2.5 21.5l3.878-1.317A9.955 9.955 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.96 7.96 0 01-4.14-1.157l-.296-.176-2.296.78.795-2.234-.193-.309A7.954 7.954 0 014 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z"/>
    </svg>
  );
}
...
export function TiktokIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.82.57-1.31 1.55-1.35 2.56-.04 1.25.59 2.45 1.62 3.12 1.02.68 2.37.78 3.48.27 1.05-.47 1.78-1.52 1.88-2.67.09-2.88.04-5.77.05-8.65.01-2.92 0-5.83.02-8.75z"/>
    </svg>
  );
}

export function WebsiteIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
